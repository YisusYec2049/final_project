...
import 'package:final_project/screen/add_category.dart';
import 'package:final_project/screen/home_admin.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class Category_Adm extends StatefulWidget {
  const Category_Adm({Key? key}) : super(key: key);

  @override
  State<Category_Adm> createState() => _Category_AdmState();
}

class _Category_AdmState extends State<Category_Adm> {
...
class CategoryPageState extends StatefulWidget {
  ...
  @override
  State<CategoryPageState> createState() => _CategoryPageStateState();
}
